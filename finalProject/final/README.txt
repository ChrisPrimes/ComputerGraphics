...
This code was heavily modified to show three different views with my specifications,
but the general idea is similar.

* Google fonts are also used on my page.

* Texture JPG's that I have used are from Pixar. https://community.renderman.pixar.com/article/114/library-pixar-one-twenty-eight.html
